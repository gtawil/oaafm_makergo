...
def main():
    ...
    PLATE_HEIGHT=np.round(abs(world_center_plate_position[2]-world_edge_plate_position[2]),4)
    print("Plate height :")
    print(PLATE_HEIGHT)
    ...
    world_finish_trajectories=currentPlate.getFinishTrajecories()

    #info plot
    currentPlate.showPositionOnPlate()

    """ 
        STEP 3 : Convert all position and trajectories in the world space to the joint space :
    """
    ...
    joint_finish_trajectories=robot.world2Joint(OAAFM_P1, world_finish_trajectories)
